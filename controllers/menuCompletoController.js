...
module.exports.getMenuUserWithData = function(req, res, MenuUsuario){
	...
	MenuUsuario.find({'_id': _id})
		.populate({path: "desayuno.idMenu"}, populate:[		
			{path: "comida", model: "Menu", populate: [
                {path: "ingred._id", model: "Ingrediente"}
            ]}
		])
		.populate({path: "comida.idMenu"}, populate:[
			{path: "comida", model: "Menu", populate: [
                {path: "ingred._id", model: "Ingrediente"}
            ]}
		])
		.populate({path: "cena.idMenu"}, populate:[
			{path: "comida", model: "Menu", populate: [
                {path: "ingred._id", model: "Ingrediente"}
            ]}
		])
		.populate({path: "colacion1"}, populate:[
			{path: "comida", model: "Menu", populate: [
                {path: "ingred._id", model: "Ingrediente"}
            ]}
		])
		.populate({path: "colacion2"}, populate:[
			{path: "comida", model: "Menu", populate: [
                {path: "ingred._id", model: "Ingrediente"}
            ]}
